...
export class CreateStoreDto {
  ...
  @ApiPropertyOptional({ example: 'https://cdn.dokanos.com/stores/gadget-hub/logo.webp' })
  @IsString()
  @IsOptional()
  logoUrl?: string;

  @ApiPropertyOptional({ example: 'https://cdn.dokanos.com/stores/gadget-hub/banner.webp' })
  @IsString()
  @IsOptional()
  bannerUrl?: string;
}
